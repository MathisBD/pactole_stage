...
(**   Mechanised Framework for Local Interactions & Distributed Algorithms 
   ...
   C. Auger, T. Balabonski, P. Courtieu, P. Pelle, L. Rieg, X. Urbain                            
...
Module Make (Location : DecidableType)
            ...
            (Config : Configuration(Location)(N)(Names)(Info)) <: PointedSpectrum (Location)(N)(Names)(Info)(Config).
...
Property pos_in_config : forall (config : Config.t) (l : Location.t) id, In (Config.loc (config id)) (snd (from_config config l)).
Proof.
