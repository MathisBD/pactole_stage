...
(*   assert (Hspec : forall pt, In pt (Spect.M.elements (!! config)) -> exists id, R2.eq pt (config id)).
  { intro. rewrite <- InA_Leibniz, Spect.M.elements_spec1. apply (Spect.from_config_spec config). } *)
