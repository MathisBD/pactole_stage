...
Definition gather (pt: R) (e : execution) : Prop := Streams.forever (Streams.instant (gathered_at pt)) e.

(** [WillGather pt e] means that (infinite) execution [e] is *eventually* [Gather]ed. *)
Definition willGather (pt : R) (e : execution) : Prop := Streams.eventually (gather pt) e.
...
(** [ValidsolGathering r d] means that any possible (infinite)
    execution, generated by demon [d] and robogram [r] and any intial
<<<<<<< HEAD:dev_coq/current-formalism/Gathering/InR/Definitions.v
    configuration not [forbidden], will *eventually* be [Gather]ed.
=======
    position not [forbidden], will *eventually* be [gather]ed.
>>>>>>> c2944b4... Définitions de eventually et forever pour les flots.:dev_coq/gathering-nD/GatheringinR/Definitions.v
