...
\begin{overlayarea}{\linewidth}{20em}
  ...
  \begin{itemize}
    \item<1-> Let $X$ : multiset of points in $R^2$
...
\begin{overlayarea}{\linewidth}{20em}
  ...
  \begin{itemize}
    \item<1-> Let \textcolor{red}{$X$}, \textcolor{green}{$Y$} : multiset of points (cf. figure).
...
\begin{overlayarea}{\linewidth}{20em}
  ...
  \begin{center}
    \includegraphics<1-4>[width=0.7\linewidth, keepaspectratio]{figures/weber_charact}
    \includegraphics<5->[width=0.7\linewidth, keepaspectratio]{figures/weber_charact_arrows}
  \end{center}
...
Definition rigid_da_prop (da:demonic_action) :=
  forall (c:configuration) (id:identifier),
    da.(activate) id = true -> 
